...
<header class="site-header">
    <div class="container header-inner">
        <a href="<?= APP_URL ?>/menu.php" class="logo">&#127860; Restaurant</a>
        <nav class="main-nav">
            <a href="<?= APP_URL ?>/menu.php" class="<?= strpos($current_path, '/menu') !== false ? 'active' : '' ?>">Menu</a>
            <a href="<?= APP_URL ?>/cart.php" class="cart-link <?= strpos($current_path, '/cart') !== false ? 'active' : '' ?>">
                Cart <span class="cart-count" id="cart-count">0</span>
            </a>
            <?php if ($current_user): ?>
                <a href="<?= APP_URL ?>/orders.php" class="<?= strpos($current_path, '/orders') !== false ? 'active' : '' ?>">My Orders</a>
                <?php if ($is_admin): ?>
