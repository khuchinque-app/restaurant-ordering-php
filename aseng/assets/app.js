...
const PARTNER_SLUG = 'tittil';
const PARTNER_PORT = 7505;
const PARTNER_NAME = 'Tittil';
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    if (partnerLink) {
        partnerLink.href = `${window.location.protocol}//${window.location.hostname}:${PARTNER_PORT}/tittil/`;
    }
