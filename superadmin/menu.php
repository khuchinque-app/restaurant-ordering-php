    ...
    <div class="modal-dialog card">
        ...
        <form id="item-form">
            ...
            <div class="form-grid">
                ...
                <div class="form-group form-full">
                    <label>Image</label>
                    <input type="url" name="image" id="item-image" class="form-control"
                    ...
                    <div style="margin-top:.5rem;display:flex;align-items:center;gap:.75rem;flex-wrap:wrap">
                        ...
                        <span id="upload-status" style="font-size:.82rem"></span>
                    </div>
                    <div id="image-preview" style="display:none;margin-top:.6rem">
                        <img id="preview-img" src="" alt="Preview"
                             style="max-height:130px;border-radius:6px;border:1px solid #e2e8f0;object-fit:cover">
                    </div>
                </div>
            </div>
